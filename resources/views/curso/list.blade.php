    ...
    <table class="table table-hover">
        <thead>
            ...
            <tr>
                ...
                <td> <a href="{{action('CursoController@edit',$dados->id)}}"><i class="fa fa-edit"></i>Editar</a></td>
                <td> <a href="{{action('CursoController@remove',$dados->id)}}" onclick="return confirm('Tem certeza que deseja remover?')"><i class="fa fa-trash"></i>Remover</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
